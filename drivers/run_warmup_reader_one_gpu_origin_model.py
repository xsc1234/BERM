...
def train(args, model, tokenizer, f, train_fn):
    ...
    task_dir = '../log/task_loss/'+args.train_model_type
    div_dir = '../log/div_loss/'+args.train_model_type
    equal_dir = '../log/equal_loss/'+args.train_model_type
    ...
    for m_epoch in train_iterator:
        ...
        for step, batch in tqdm(enumerate(epoch_iterator),desc="Iteration",disable=False):
...
def main():
    ...
    if args.do_train:
        ...
        with open(args.data_dir+"/triples.train.small_with_id.tsv", encoding="utf-8-sig") as f:
